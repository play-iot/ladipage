...
//            var utc = date.getTime() + (date.getTimezoneOffset() * 60000) - (360000*100);
            let utc = date.getTime() + (date.getTimezoneOffset() * 60000) - (360000 * 100) + (360000 * 10) * timeZone;
...
//            var _second = 1000,
            ...
            let minRot = (360 * minCount) + minutes * 6 + 'deg';
            let secRot = (360 * secCount) + seconds * 6 + 'deg';
        ...
        if ($('.clock-container').length || $('.alt-clock').length) {
            interval = setInterval(countdown, 250 * 1);
        } else {
            interval = setInterval(countdown, 250 * 1);
        }
    };
